...
folder are mapped to the application's root namespace, 'MyTorrent'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MyTorrent' in the same way
as `"MyTorrent/sass/src"`.
